...
import com.hust.common.annotation.CacheAction;
import com.hust.common.annotation.CacheCollection;
import com.hust.common.annotation.CacheMap;
import com.hust.common.annotation.CacheUpdate;
import com.hust.common.util.ReflectionUtil;
...
public class CacheAspect {
     ...
     * @param cacheCollection the cache collection annotation
     * @param returnValue the return value of function
    ...
    public void cacheCollectionUpdate(final JoinPoint joinPoint, CacheCollection cacheCollection,
        ...
        if (Objects.nonNull(condition)) {
            ...
            boolean conditionResult = Boolean.TRUE.equals(conditionExp.getValue(context, Boolean.class));
        ...
        for (String cacheName : cacheNames) {
            ...
            if (Objects.nonNull(ob) && Collection.class.isAssignableFrom(ob.getClass().getSuperclass())) {
    ...
    public void cacheMapUpdate(final JoinPoint joinPoint, CacheMap cacheMap,
        ...
        for (String cacheName : cacheNames) {
            ...
            if (Objects.nonNull(ob) && Map.class.isAssignableFrom(ob.getClass().getSuperclass())) {
     ...
     * @param returnValue the return object of function
     * @param compareProperties the array of properties to compare two objects
