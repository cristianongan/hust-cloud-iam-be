...
public class GetterUtil {
	...
	public static boolean get(String value, boolean defaultValue) {
		if (value != null) {
			try {
				...
				return value.equalsIgnoreCase(BOOLEANS[0]) || value.equalsIgnoreCase(BOOLEANS[1])
	...
	public static Boolean get(String value, Boolean defaultValue) {
		...
		try {
			return Boolean.valueOf(trimString(value));
		} catch (Exception e) {
			return defaultValue;
		}
	}
	...
	public static Double get(String value, Double defaultValue) {
		try {
			return Double.valueOf(trimString(value));
		} catch (Exception e) {
			return defaultValue;
		}
	}
	...
	public static float get(String value, float defaultValue) {
		try {
			return Float.parseFloat(trimString(value));
		} catch (Exception e) {
			return defaultValue;
		}
	}
	...
	public static Float get(String value, Float defaultValue) {
		try {
			return Float.valueOf(trimString(value));
		} catch (Exception e) {
			return defaultValue;
		}
	}
	...
	public static Integer get(String value, Integer defaultValue) {
		try {
			return Integer.valueOf(trimString(value));
		} catch (Exception e) {
			return defaultValue;
		}
	}
	...
	public static Long get(String value, Long defaultValue) {
		try {
			return Long.valueOf(trimString(value));
		} catch (Exception e) {
			return defaultValue;
		}
	}
	...
	public static short get(String value, short defaultValue) {
		try {
			return Short.parseShort(trimString(value));
		} catch (Exception e) {
			return defaultValue;
		}
	}
	...
	public static Short get(String value, Short defaultValue) {
		try {
			return Short.valueOf(trimString(value));
		} catch (Exception e) {
			return defaultValue;
		}
	}
