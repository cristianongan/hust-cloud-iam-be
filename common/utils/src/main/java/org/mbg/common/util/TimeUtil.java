...
public class TimeUtil {
    ...
    public static String getDescription(
        ...
        if (approximate) {
            if (milliseconds <= 0) {
                s = "0 Seconds";
            } else if (milliseconds < MINUTE || milliseconds % SECOND == 0) {
                x = (int) (milliseconds / SECOND);

                s = x + " Second";
            } else if (milliseconds < HOUR || milliseconds % MINUTE == 0) {
                x = (int) (milliseconds / MINUTE);

                s = x + " Minute";
            } else if (milliseconds < DAY || milliseconds % HOUR == 0) {
                x = (int) (milliseconds / HOUR);

                s = x + " Hour";
            } else if (milliseconds < MONTH || milliseconds % DAY == 0) {
