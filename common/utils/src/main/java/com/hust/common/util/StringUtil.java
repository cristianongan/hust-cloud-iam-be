...
public class StringUtil {
    ...
    /**
     * Adds the specified string to the end of the string buffer
     *
     * @param s the s
     * @param add the add
     * @return the string
     ...
     * @param add the add
     * @param delimiter the delimiter
     * @param allowDuplicates to allow duplicates
     * @return the string
     */
    ...
    public static String formatLaPhoneNumber(String phoneNumber) {
        if (Validator.isNull(phoneNumber)) {
            return null;
        }

        if (phoneNumber.startsWith(Constants.PhoneNumber.PREFIX)) {
            phoneNumber = phoneNumber.replaceFirst(Constants.PhoneNumber.PREFIX, Constants.PhoneNumber.LA_COUNTRY_CODE);
        }
     ...
     * @return the phone number formatted by Vietnamese format
     */
    public static String formatVnPhoneNumber(String phoneNumber) {
        if (Validator.isNull(phoneNumber)) {
            return null;
        }

        if (phoneNumber.startsWith(Constants.PhoneNumber.PREFIX)) {
            phoneNumber = phoneNumber.replaceFirst(Constants.PhoneNumber.PREFIX, Constants.PhoneNumber.VN_COUNTRY_CODE);
        }
     ...
     * @param fromIndex the start index of the string
     * @param toIndex the end index of the string
     * @param mask the mask
     * @return the string
     */
    public static String hide(String s, int fromIndex, int toIndex, String mask) {
        ...
        return s.substring(0, fromIndex) +
                mask +
                mask +
                mask +
                s.substring(toIndex, s.length());
    }
     ...
     *
     * @param maps the maps
     * @param mapSeparator the map separator
     * @param separator the separator
     * @return the string
     */
    public static String join(Map<?, ?> maps, String mapSeparator, String separator) {
        List<String> mapStr = new ArrayList<>();

        for (Map.Entry<?, ?> entry : maps.entrySet()) {
            mapStr.add(GetterUtil.getString(entry.getKey()) + mapSeparator + GetterUtil.getString(entry.getValue()));
        }

        return join(mapStr, separator);
    }
    
    /**
     * Join.
     *
     * @param maps the MultiValueMaps
     * @param mapSeparator the map separator
     * @param separator the separator
     * @return the string
     */
    public static String join(MultiValueMap<?, ?> maps, String mapSeparator, String separator) {
        List<String> mapStr = new ArrayList<>();
    ...
    /**
     * Removes a string sequence from the given string
     *
     * @param s the s
    ...
    public static String remove(String s, String remove, String delimiter) {
        ...
        if (Objects.nonNull(s) && !s.endsWith(delimiter)) {
            s += delimiter;
        }
     ...
     * @param values the map values to replace
     * @return the string representation
     */
    public static String replaceMapValue(String s, Map<String, String> values) {
        if (Objects.nonNull(s) && Objects.nonNull(values)) {
    ...
    public static StringBuilder replaceToStringBuilder(String s, String begin, String end, Map<String, String> values) {
        ...
        if (begin == null || end == null || values == null || values.size() == 0) {
     ...
     * 
     * @param s the string
     * @return the string after truncation
     */
    public static String shuffle(String s) {
        ...
        IntStream.range(0, s.length()).forEach(index -> {
            int randomPosition = new SecureRandom().nextInt(characters.size());

            sb.append(characters.get(randomPosition));
    ...
    public static boolean[] split(String s, String delimiter, boolean x) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            try {
                ...
                _log.error("Cannot slit parse boolean value: {}", array[i]);
            }
    ...
    public static double[] split(String s, String delimiter, double x) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            try {
                ...
                _log.error("Cannot slit parse double value: {}", array[i]);
            }
    ...
    public static float[] split(String s, String delimiter, float x) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            try {
                ...
                _log.error("Cannot slit parse float value: {}", array[i]);
            }
    ...
    public static int[] split(String s, String delimiter, int x) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            try {
                ...
                _log.error("Cannot slit parse integer value: {}", array[i]);
            }
    ...
    public static long[] split(String s, String delimiter, long x) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            try {
                ...
                _log.error("Cannot slit parse long value: {}", array[i]);
            }
    ...
    public static short[] split(String s, String delimiter, short x) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            try {
                ...
                _log.error("Cannot slit parse short value: {}", array[i]);
            }
    ...
    public static String[] splitIntoLine(String input, int maxCharInLine) {
        ...
        while (token.hasMoreTokens()) {
            ...
            while (word.length() > maxCharInLine) {
                output.append(word, 0, maxCharInLine - lineLength);
    ...
    public static String[] splitLines(String s) {
        ...
        while (true) {
            ...
            if (returnIndex == -1 || newLineIndex < returnIndex) {
     ...
     *
     * @param s the s
     * @param begin the beginning char of the string
     * @return true, if successful
     */
     ...
     * @param separator the separator
     * @param isLastSeparator whether the string should be returned
     * @return the converted string
     */
    public static String subAfter(String string, String separator, boolean isLastSeparator) {
        if (isEmpty(string)) {
            return null == string ? null : StringPool.BLANK;
        }
    ...
    public static String substring(String s, int beginIndex, int endIndex) {
        int maxLength = Math.min(s.length(), endIndex);
    ...
    public static String unquote(String s) {
        ...
        if ((s.charAt(0) == CharPool.APOSTROPHE && s.charAt(s.length() - 1) == CharPool.APOSTROPHE)
                        || (s.charAt(0) == CharPool.QUOTE && s.charAt(s.length() - 1) == CharPool.QUOTE)) {
     ...
     * @return the string
     */
    private static String highlight(String s, Pattern pattern, String highlight1, String highlight2) {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (matcher.find()) {
                ...
                do {
                    matcher.appendReplacement(highlighted, highlight1 + matcher.group() + highlight2);
                } while (matcher.find());
    ...
    /**
     * Checks if is trimble.
     *
     * @param c the c
     * @param exceptions the exceptions
     * @return true, if successful
     */
    private static boolean isTrimble(char c, char[] exceptions) {
        if (exceptions != null) {
