...
public class ArrayUtil {
	...
	/**
	 * Appends multiple boolean arrays into a single array.
	 * <p>
	 * <b>Example :</b> <br/>
	 ...
	 * false
	 *
	 * @param arrays A list of boolean arrays, with no limit on the number of arrays
	 * passed in.
	 * @return The combined boolean array.
	 */
	...
	/**
	 * Adds a boolean value to a given boolean array
	 * <p>
	 * <b>Example:</b> <br/>
	 * boolean[] a1 = new boolean[]{true, false}; <br/>
	 * boolean a2 = false; <br/>
	 ...
	 * false
	 *
	 * @param array The initial boolean array
	 * @param value The boolean value to be added to the array
	 * @return A new boolean array with the added element
	 */
	 ...
	 * -118
	 *
	 * @param arrays Variable number of byte arrays to be concatenated
	 * @return A byte array containing all input arrays concatenated
	 */
	...
	/**
	 * Adds a byte value to a given byte array
	 * <p>
	 * <b>Example:</b> <br/>
	 * byte[] a1 = new byte[]{(byte)0xe0, 0x4f}; <br/>
	 ...
	 * -70
	 *
	 * @param array The initial byte array
	 * @param value The byte value to be added to the array
	 * @return A new byte array with the added element
	 */
	 ...
	 * d
	 *
	 * @param arrays Variable number of char arrays to be concatenated
	 * @return A char array containing all input arrays concatenated
	 */
	...
	/**
	 * Adds a char value to a given char array
	 * <p>
	 * <b>Example:</b> <br/>
	 * char[] a1 = new char[]{'a', 'b'}; <br/>
	 * char a2 = 'c'; <br/>
	 ...
	 * c
	 *
	 * @param array The initial char array
	 * @param value The char value to be added to the array
	 * @return A new char array with the added element
	 */
	 ...
	 * 4.4
	 *
	 * @param arrays Variable number of double arrays to be concatenated
	 * @return A double array containing all input arrays concatenated
	 */
	...
	/**
	 * Adds a double value to a given double array
	 * <p>
	 * <b>Example:</b> <br/>
	 * double[] a1 = new double[]{1.1, 2.2}; <br/>
	 * double a2 = 3.3; <br/>
	 ...
	 * 3.3
	 *
	 * @param array The initial double array
	 * @param value The double value to be added to the array
	 * @return A new double array with the added element
	 */
	 ...
	 * 4.4
	 *
	 * @param arrays Variable number of float arrays to be concatenated
	 * @return A float array containing all input arrays concatenated
	 */
	...
	/**
	 * Adds a float value to a given float array
	 * <p>
	 * <b>Example:</b> <br/>
	 * float[] a1 = new float[]{1.1f, 2.2f}; <br/>
	 * float a2 = 3.3f; <br/>
	 ...
	 * 3.3
	 *
	 * @param array The initial float array
	 * @param value The float value to be added to the array
	 * @return A new float array with the added element
	 */
	 ...
	 * 4
	 *
	 * @param arrays Variable number of int arrays to be concatenated
	 * @return An int array containing all input arrays concatenated
	 */
	 ...
	 * 4
	 *
	 * @param arrays Variable number of long arrays to be concatenated
	 * @return A long array containing all input arrays concatenated
	 */
	...
	/**
	 * Adds a long value to a given long array
	 * <p>
	 * <b>Example:</b> <br/>
	 * long[] a1 = new long[]{1L, 2L}; <br/>
	 * long a2 = 3L; <br/>
	 ...
	 * 3
	 *
	 * @param array The initial long array
	 * @param value The long value to be added to the array
	 * @return A new long array with the added element
	 */
	 ...
	 * 4
	 *
	 * @param arrays Variable number of short arrays to be concatenated
	 * @return A short array containing all input arrays concatenated
	 */
	...
	/**
	 * Adds a short value to a given short array
	 * <p>
	 * <b>Example:</b> <br/>
	 * short[] a1 = new short[]{1, 2}; <br/>
	 * short a2 = 3; <br/>
	 ...
	 * 3
	 *
	 * @param array The initial short array
	 * @param value The short value to be added to the array
	 * @return A new short array with the added element
	 */
	...
	/**
	 * Concatenates multiple object arrays into a single array
	 * <p>
	 * <b>Example:</b> <br/>
	 * Long[] a1 = new Long[]{1L, 2L}; <br/>
	 * Long[] a2 = new Long[]{3L, 4L}; <br/>
	 ...
	 * 4
	 *
	 * @param arrays List of object arrays with no limit on the number of arrays passed.
	 *               Objects can be Object, String, Long, Integer, Short,
	 *               Double, Float, or any other object.
	 * @return An object array containing all input arrays concatenated
	 */
	@SafeVarargs
	public static <T> T[] append(T[]... arrays) {
		return Stream.of(arrays)
				...
				.toArray(size -> {
					...
					T[] result = (T[]) Array.newInstance(arrays[0].getClass().getComponentType(), size);
	...
	/**
	 * Adds an object to an array of the same type of objects
	 * <p>
	 * <b>Example:</b> <br/>
	 * Long[] a1 = new Long[]{1L, 2L}; <br/>
	 * Long a2 = 3L; <br/>
	 ...
	 * 3
	 *
	 * @param array The initial array of objects
	 * @param value The object to be added to the array. Can be Object, String,
	 *              Long, Integer, Short, Double, Float, or any other object.
	...
	/**
	 * Concatenates two object arrays into a single array. Objects can be Object,
	 * String, Long, Integer, Short, Double, Float, or any other object
	 * <p>
	 * <b>Example:</b> <br/>
	 * Long[] a1 = new Long[]{1L, 2L}; <br/>
	 * Long[] a2 = new Long[]{3L, 4L}; <br/>
	...
	/**
	 * Adds a one-dimensional array to a two-dimensional array of the same object type.
	 * Objects can be Object, String, Long, Integer, Short, Double, Float, or any other object
	 * <p>
	 * <b>Example:</b> <br/>
	 * Long[] a1 = new Long[]{1L, 2L}; <br/>
	 * Long[] a2 = new Long[]{3L, 4L}; <br/>
	 ...
	 * 6
	 *
	 * @param array1 The initial two-dimensional array
	 * @param value  The one-dimensional array to be added
	 * @return A new two-dimensional array after appending
	 */
	...
	/**
	 * Concatenates two two-dimensional object arrays. Objects can be Object, String,
	 * Long, Integer, Short, Double, Float, or any other object
	 * <p>
	 * <b>Example:</b> <br/>
	 * Long[] a1 = new Long[]{1L, 2L}; <br/>
	...
	/**
	 * Creates an exact copy of a boolean array
	 *
	 * @param array The boolean array to be cloned
	 * @return A new boolean array with the same elements as the input array
	 */
	...
	/**
	 * Creates a copy of a boolean array from a specified start index to an end index
	 * <p>
	 * <b>Example:</b> <br/>
	 ...
	 * @return A new boolean array containing elements from the specified range
	 * @throws IllegalArgumentException if from or to indices are invalid
	 */
